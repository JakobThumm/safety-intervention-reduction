...
class Motion {
  ...
  */
  ...
  /**
   * @brief Returns the recommended action for the motion
   *
   * @return the action of the motion
   */
  inline std::vector<double> getAction() { return action_; }
   ...
   *
   * @param new_action the new motion's action
   */
  inline void setAction(const std::vector<double> &new_action) {action_ = new_action; }
