...
#
# Overrides the Safety Gym environment with the functions defined in gym_engine.
# v1 environments can be used by calling `register_all()` even without installing the safety gym, if the other prerequisites (mujoco...) are fulfilled.
#
    ...
    def register(self, name='', config={}):
        ...
        for robot_name, robot_config in self.robot_configs.items():
            ...
            register(id=env_name,
                     entry_point='src.env.mujoco:NewEngine',
